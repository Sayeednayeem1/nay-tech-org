...
const About = () => {
    return (
        <div className='bg-gradient-to-r from-cyan-500 to-blue-500 py-10 mt-16 mb-16'>
            <div className='mx-4 md:mx-36'>
                <div className='flex flex-col md:flex-row items-center'>
                    <div className='mr-0 md:mr-28'>
                        <p className='text-orange-600 mb-4'>About Company</p>
                        <h1 className='mb-4'>We believe, one idea begets others, but one great idea stays stronger above all.</h1>
